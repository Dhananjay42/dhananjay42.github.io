...
1. NFHS-4 and NFHS-5 data
2. Census Data from 2011
3. COVID case data

## Outcomes

While we did not observe significant effects of COVID on increasing the gap itself, what we observed was undeniably large caste-based disparities in child nutrition outcomes such as stunting and underweight rate. This is seen in the table below, and specific details on methodology can be found in the report attached at the end. 
